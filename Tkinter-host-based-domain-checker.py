...
def update_hosts_file(block_ads, block_malware, block_tracking):
...
def create_gui():
    ...
    tk.Button(root, text="Update Hosts File", command=lambda: update_hosts_file(block_ads.get(), block_malware.get(), block_tracking.get())).pack(pady=10)
